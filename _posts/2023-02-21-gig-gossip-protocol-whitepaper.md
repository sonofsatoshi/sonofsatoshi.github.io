---
layout: post
title:  "Gig-Gossip Protocol: Decentralized P2P Gig Economy"
description: Gig-Gossip is a decentralized, peer-to-peer protocol for gig economy applications, such as ride-sharing and freelance work. The protocol enables direct communication, negotiation, and secure payments using Bitcoin and the Lightning Network, all without central intermediaries. With Gig-Gossip, customers and service providers connect directly through a P2P network, negotiate prices on a free market, and make secure payments using Bitcoin and the Lightning Network. This eliminates the need for centralized platforms and intermediaries, creating a more efficient and cost-effective marketplace...
date:   2023-02-21 11:02:01 +11:00
...
![Centralised vs. Decentralised System](/images/centdecent.png)
...
![The intuition behind gossip protocol](/images/network.png)
...
classDiagram
    ...
    <em>The AskForBroadcastFrame</em>
</div>
...
sequenceDiagram
    ...
    <em>Ping Pong communication sequence</em>
</div>
...
classDiagram
    ...
    <em>OnionRoute and OnionLayer</em>
</div>

![Onion Routing](/images/onion.png) 
...
classDiagram
    ...
    <em>POWBroadcastConditionsFrame</em>
</div>
...
sequenceDiagram
    ...
    <em>Cryptographic Payment Chain Sequence</em>
</div>
...
sequenceDiagram
    ...
    <em>Reply/Payment/Decryption Sequence</em>
</div>
...
sequenceDiagram
    ...
    <em>Payment/Settlement Sequence</em>
</div>
